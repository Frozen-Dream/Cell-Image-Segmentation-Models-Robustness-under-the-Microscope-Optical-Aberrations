...
from LiveCell_Data import LiveCellData
...
def main(args):
    ...
    # train_dataset = CellDataset(data_root, "train", data_transform["train"])
    train_dataset = CellDataset(root=data_root, dataset="train", transform=None)
    train_sampler = None
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lr-steps', default=[44, 54], nargs='+', type=int,
