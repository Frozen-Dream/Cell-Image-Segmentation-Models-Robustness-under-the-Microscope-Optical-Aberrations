...
class CellDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        img = Image.fromarray(self.X[idx, :, :, 0]).convert('L')
...
# dataset = CellDataset(root='/home/server/Desktop/Project/dataset/DynamicNuclearNet-segmentation-v1_0',dataset='train')
# print(dataset[700])